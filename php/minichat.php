   ...
   <body>
      <div class="liste">
         ...
         <ul id="myUL">
            ...
            <li>
               <a>
                  <!--on renvoie sur la meme page le but etant d'avoir juste le pseudo-->
                  <form name="myForm" action="minichat.php"  
                     method="post">
                     <!-- la balise forme permet de renvoyer le pseudo lorsqu'on clique dessus pour pouvoir ensuite afficher les bon message-->
                     <input name="destinataire" type="submit" value="<?php echo htmlspecialchars($donnees['pseudo'])?> ">
                  </form>
               </a>
            </li>
            <?php // on ecris dans chaque imput les pseudo de la base de donné
               }
               ?>
         </ul>
      </div>
